        ...
        <>
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <h2 className="title font-bold text-center pb-5">
                        Want to <span className="text-blue-600"> get in touch?</span>
                    </h2>
                    <p className="text-lg text-center font-bold text-gray-600 pb-10">Fill up the form and our team will get back to you within 24 hours.</p>
