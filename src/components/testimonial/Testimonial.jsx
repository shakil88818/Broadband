            ...
            <section className="bg-white text-gray-900 py-16 md:py-20">
                <div className="">
                    <div className="pb-20">
                        ...
                        What customers<span className="text-blue-600"> say about us</span>
                        </h2>
                    </div>
                                        ...
                                        <div key={testi.id} className="max-w-screen-xl mx-auto text-center ">
                                            <figure className="max-w-screen-md mx-auto">
                                                ...
                                                <figcaption className="flex items-center justify-center mt-6 space-x-3">
                                                    ...
                                                    <div className="mb-5 flex items-center divide-x-2 divide-gray-500 ">
                                                        <div className="pr-3 font-medium">{testi.name}</div>
                                                        <div className="pl-3 text-sm font-light text-gray-500 ">{testi.position}</div>
                                                    </div>
                                                </figcaption>
                                            </figure>
                                        </div>
